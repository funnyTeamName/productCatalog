  ...
  return (
    <div className="card">
      ...
      <div className="card__description-content">
        <p className="card__product-title">{phone.name}</p>
        ...
        <div className="card__description">
          <div className="card__product-description">
            <span className="card__subtitle">Screen</span>

            <span className="card__features">{phone.screen}</span>
          </div>

          <div className="card__product-description">
            <span className="card__subtitle">Capacity</span>

            <span className="card__features">{phone.capacity}</span>
          </div>

          <div className="card__product-description">
            <span className="card__subtitle">RAM</span>

            <span className="card__features">{phone.ram}</span>
          </div>
        </div>
